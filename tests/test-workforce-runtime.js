// Test for workforce runtime functions
const { buildBriefing, extractCompanyFromStep } = require('../services/workforce/runtime');

console.log('Testing Workforce Runtime Functions...\n');
